        ...
        <group position={position} ref={groupRef}>
            ...
            <group position={[0, 0, 0]}>
                ...
                <mesh castShadow receiveShadow position={[0, 0, -0.8]}>
                    ...
                    <meshStandardMaterial color="#c8c4b0" roughness={0.6} metalness={0.05} />
                </mesh>

                {/* Front bezel */}
                <mesh position={[0, 0, 0.15]} castShadow>
                    <boxGeometry args={[2.5, 2.3, 0.3]} />
                    <meshStandardMaterial color="#d4d0bc" roughness={0.5} metalness={0.05} />
                </mesh>
                ...
                {/* CRT Screen — single render, full CRT shader effect */}
                <mesh
                    position={[0, 0.1, 0.35]}
